...
export const CelestialPage = () => {
  ...
  return (
    <div className="w-screen h-screen relative">
      <img
        src="/images/celestial/行星状星云.webp"
        alt=""
        ...
        <div className="container max-w-[690px]">
          <div className="title w-full h-auto text-right flex justify-end items-center">
            <div className="flex flex-col">
              <div className="text-6xl mb-2">行星状星云</div>
              <div className="text-2xl uppercase">BlackHole</div>
            </div>
      ...
      <div className="absolute top-[20%] left-[58px] flex flex-col z-10">
        <div className="flex flex-col cursor-pointer" onClick={() => setActiveNav(0)}>
          <div
            className={cn(
